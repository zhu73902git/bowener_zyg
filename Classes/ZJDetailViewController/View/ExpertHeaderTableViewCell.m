...
#import "ExpertHeaderTableViewCell.h"


@interface ExpertHeaderTableViewCell ()
...
@implementation ExpertHeaderTableViewCell
...
- (void)setDict:(NSDictionary *)dict{
    ...
    self.fieldLabel.text = [NSString stringWithFormat:@"领域:%@",dict[@"field"]];
...
- (UIButton *)concernButton{
    if (!_concernButton) {
        ...
        _concernButton.titleLabel.font = BWFont(14);
        _concernButton.layer.borderColor =[UIColor grayColor].CGColor;
        _concernButton.layer.borderWidth = 1.2;
